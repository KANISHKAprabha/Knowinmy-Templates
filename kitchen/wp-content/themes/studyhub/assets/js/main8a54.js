...
* --------------------------------------------------------------------
*
* Template : studyhub - Education WordPress Theme
...
(function ($) {
    ...
    $(window).on('load', function () {
        $("#studyhub-load").delay(300).fadeOut(200);
        $("#loading").delay(300).fadeOut(200);
        $(".studyhub-loader").delay(300).fadeOut(200);
    ...
    $(".archive--show-filter").click(function(){
        $(".course-archive-2").toggleClass("active");
    });
    ...
    // Course Columns views
    $('.column-style-filter #list-view').click(function () {
        $('.archive-curse-container').addClass('view-style-list');
    })
    $('.column-style-filter #grid-view').click(function () {
        $('.archive-curse-container').removeClass('view-style-list');
    })
